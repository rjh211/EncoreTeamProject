...
public class MemberDaoImpl implements MemberDao {
	...
	public void InsertCar(CarVO cvo) {
		// TODO Auto-generated method stub

		String sql = "insert into car values(?,?,?,?,?,?,?)where isAccepted = 1";
		// 1. db 커넥션 수립
		Connection conn = db.getConnect();
		try {
			// 2. 커넥션 객체로 스테이트먼트 객체 생성
...
//		// TODO Auto-generated method stub
//		String sql = "select * from car where isAccepted = 0 AND guest = false";
//		ArrayList<CarVO> list = new ArrayList<CarVO>();
//		ResultSet rs = null;
//		Connection conn = db.getConnect();
//		try {
...
//
//			// TODO Auto-generated method stub
//			String sql = "select * from car where isAccepted = 0 AND guest = true";
//			ArrayList<CarVO> list = new ArrayList<CarVO>();
//			ResultSet rs = null;
//			Connection conn =db.getConnect();
//			try {
